...
export class PalSplitComponent implements OnInit {
  ...
  @ViewChild('scanFromPallet',{static:false}) scanFromPallet
  @ViewChild('scanToPallet',{static:false}) scanToPallet
  @ViewChild('scanItemCode',{static:false}) scanItemCode
  @ViewChild('scanBatchSerial',{static:false}) scanBatchSerial
