...
export class InboundGRPOComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild('RecBinVal',{static:false}) RecBinVal: ElementRef;
  newCreatedPalletNo: string;
  @ViewChild('scanPallet',{static:false}) scanPallet: ElementRef;
  @ViewChild('scanTargetWhse',{static:false}) scanTargetWhse: ElementRef;
  @ViewChild('scanTargetBin',{static:false}) scanTargetBin: ElementRef;
  @ViewChild('scanBatchSerial',{static:false}) scanBatchSerial: ElementRef;
  @ViewChild('scanQty',{static:false}) scanQty;
