...
export class InputContainerCodeComponent implements OnInit {
  ...
  IsvalidParentCode(){
    ...
    this.oSaveModel.HeaderTableBindingData[0].OPTM_PURPOSE,operation,this.oSaveModel.HeaderTableBindingData[0].OPTM_CREATEMODE, true).subscribe(
      (data: any) => {
        this.showLoader = false;
        if (data != undefined) {
          if (data.LICDATA != undefined && data.LICDATA[0].ErrorMsg == "7001") {
  ...
  onContainerCodeChange(){
    ...
    this.oSaveModel.HeaderTableBindingData[0].OPTM_PURPOSE, operation, this.oSaveModel.HeaderTableBindingData[0].OPTM_CREATEMODE, false).subscribe(
      (data: any) => {
        this.showLoader = false;
        if (data != undefined) {
          if (data.LICDATA != undefined && data.LICDATA[0].ErrorMsg == "7001") {
