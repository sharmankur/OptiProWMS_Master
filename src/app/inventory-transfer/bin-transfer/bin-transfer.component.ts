...
export class BinTransferComponent implements OnInit {
  ...
  palletList: any = [];
  @ViewChild("scanItemCode",{static:false}) scanItemCode;
  @ViewChild("scanFromBin",{static:false}) scanFromBin;
  @ViewChild("scanToBin",{static:false}) scanToBin;
  @ViewChild("scanLotNo",{static:false}) scanLotNo;
  @ViewChild("scanPallet",{static:false}) scanPallet;
  @ViewChild("scanToBinOther",{static:false}) scanToBinOther;
  @ViewChild("scanTransQty",{static:false}) scanTransQty;
  @ViewChild("scanReason",{static:false}) scanReason;
  @ViewChild("scanReasonByPallet",{static:false}) scanReasonByPallet;
  ...
  @ViewChild('transferedItemsBtn',{static:false}) transferedItemsBtn: ElementRef;
