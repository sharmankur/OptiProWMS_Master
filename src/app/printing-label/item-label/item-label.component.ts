...
export class ItemLabelComponent implements OnInit {
  ...
  @ViewChild('itemCodeIp',{static:false}) itemCodeIp: ElementRef;
  @ViewChild('batchSrBinIp',{static:false}) batchSrBinIp: ElementRef;
  @ViewChild('noOfCopiesIp',{static:false}) noOfCopiesIp: ElementRef;
