...
export class ProductionReceiptComponent implements OnInit {
  ...
  @ViewChild('SerialQty',{static:false}) SerialQtyField: ElementRef;
  @ViewChild('BatchQty',{static:false}) BatchQtyField: ElementRef;
  @ViewChild('Qty',{static:false}) QtyField: ElementRef;
  dateFormat: string;
  pagable: boolean = false;
  pageSize:number = Commonservice.pageSize;
  @ViewChild('scanOrderNo',{static:false}) scanOrderNo;
